...
- **Spending** (`/dashboard/spending`): shows a **Daily Usage Pace** overlay with Cursor and Other columns (current pace vs budget pace per pool) from `/api/usage-summary`.
